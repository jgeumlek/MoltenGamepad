...
public:
  ...
  virtual void text(const std::string& text) const = 0;
  virtual void message(const std::string& text, oscpkt::PacketWriter& packet) const = 0;
...
public:
  ...
  virtual void text(const std::string& text) const;
  virtual void message(const std::string& text, oscpkt::PacketWriter& packet) const;
