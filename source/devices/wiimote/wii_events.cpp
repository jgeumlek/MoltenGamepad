...
{EVNAME(nk_wm_accel_x),"[NOT WORKING]Wiimote X acceleration with Nunchuk",ABS},
{EVNAME(nk_wm_accel_y),"[NOT WORKING]Wiimote Y acceleration with Nunchuk",ABS},
{EVNAME(nk_wm_accel_z),"[NOT WORKING]Wiimote Z acceleration with Nunchuk",ABS},
{EVNAME(nk_ir_x),"[NOT WORKING]Wiimote IR pointer X with Nunchuk",ABS},
{EVNAME(nk_ir_y),"[NOT WORKING]Wiimote IR pointer Y with Nunchuk",ABS},
